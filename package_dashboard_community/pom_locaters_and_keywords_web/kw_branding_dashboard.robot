...
***Variables***
${dashboard event branding xpath}                                   xpath\=//span[normalize-space()\='BRANDING']
...
${add banner button xpath}                                          xpath\=//input[@name\='community_banner']
${event logo button xpath}                                          xpath\=//input[contains(@name,'logo')]
${community login banner button xpath}                              xpath\=//input[@name\='community_login_banner']
...
${uploaded community login banner image element xpath}              xpath\=(//img[contains(@alt,'login_banner')])[1]
${uploaded community login banner image delete element xpath}       xpath\=(//button[@title\='Delete'])[1]
${uploaded community banner1st image xpath}                         xpath\=//img[@alt\='community_banner']
${community banner delete popup xpath}                              xpath\=//body/div[@role\='presentation']/div/div[1]
# (//div[contains(@class,'')]//button[contains(@title,'Delete')])[2]
# //body/div[contains(@role,'presentation')]/div/div[1]
${community banner delete popup text xpath}                         xpath\=//h3[normalize-space()\='You are about to delete community banner']
${community banner delete popup delete button xpath}                xpath\=//div[@role\='presentation']//div[1]//div[1]//div[4]//button[2]
${community banner delete popup cancel button xpath}                xpath\=//body//div[contains(@role,'presentation')]//div//div//button[1]
...
${community login banner cropping popup xpath}                      xpath\=//div[@role\='presentation']/div[3]/div[2]

${dashboard welcome video youtube added play button}                xpath\=//button[@title\='Play']//span
# //button[@title\='Play']//span[@class\='MuiButton-label']//*[name()\='svg']
# (//button[contains(@type,'button')])[22]
${dashboard welcome video youtube added delete button}              xpath\=(//button[@type='button'])[21]
${dashboard welcome video youtube delete popup iframe xpath}        xpath\=//body/div[contains(@role,'presentation')]/div/div[1]
${dashboard welcome video youtube delete popup iframe cancel button xpath}      xpath\=//span[contains(text(),'CANCEL')]
${dashboard welcome video youtube delete popup iframe delete button xpath}      xpath\=//span[contains(text(),'Delete')]
${uploaded community banner1st image and the delete option xpath}           xpath\=(//div[contains(@class,'')]//button[contains(@title,'Delete')])[2]
${dashboard event logo uploaded image xpath}                        xpath\=//img[@alt\='Event_logo']
${dashboard event logo uploaded image delete button xpath}          xpath\=//img[contains(@alt,'Event_logo')]
# //body/main[@id\='root']/div[2]/section[1]/section[1]/div[1]/div[1]/div[1]/div[1]/div[12]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/button[2]

${uploaded community event favicon logo image and the delete option xpath}           xpath\=(//button[contains(@title,'Delete')])[1]
# //body//main[@id\='root']//section//section//div[2]//div[1]//div[1]//div[1]//div[1]//div[1]//button[1]

${last community login banner image on the dashboard xpath}         xpath\=//body/main[@id\='root']/div[2]/section[1]/section[1]/div[1]/div[1]/div[1]/div[1]/div[13]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/button[1]
...
${community banner 1 image}                     ${branding_folder_path}Community_Banners_Final.jpg

${video title is}      palipoint Virtual Event Platform
...
KW: Verify the branding side element is present.
    QWeb.Verify Element         ${dashboard event branding xpath}

KW: Click on the Branding module.
    QWeb.Click Element          ${dashboard event branding xpath}
...
KW: Verify the text are present within the branding module.
    Verify All      Brand Your Event, You are able to configure the domain name, select your colour theme and upload your own community banners, login banner and event logo, This will help the attendee to connect with your brand and buy into your brand promise, Learn More, Event Domain, Know more in Event Branding
...
KW: Verify Community Banners Page info details.
    Verify All      Community Banners, 1200x400px, | 5MB (Maximum), Maximum 50 allowed. Know more in Event Branding
...
KW: Verify the Login Banners button is present.
    QWeb.Verify Element         ${community login banner button xpath}
...
KW: Verify the uploaded favicon image on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
...
KW: Upload invalid image for the community banner.
    Wait Until Keyword Succeeds         10sec       1sec        Upload File     ${add banner button xpath}     ${maroon branding color}       anchor=Community Banners

KW: Verify the invaid image upload community banner alert.
...
KW: Upload valid image for the community banner but will remove it to check the delete is working or not.
    Wait Until Keyword Succeeds         10sec       1sec        Upload File     ${add banner button xpath}     ${community banner 1 image}       anchor=Community Banners

KW: Hover upon the uploaded community banner image.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${uploaded community banner1st image xpath}
    # QWeb.Click Element      ${uploaded community banner1st image xpath}
...
KW: Hover upon the delete option, which is a added community banner once hovered.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${uploaded community banner1st image and the delete option xpath}

KW: Click the delete icon over the community banner.
    # Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
...
KW: Wait for the delete community popup alert.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${community banner delete popup xpath}

KW: Wait for the community banner delete permission popup text.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element Text     ${community banner delete popup text xpath}     You are about to delete community banner

KW: Verify the delete and cancel element is present on the community banner popup.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${community banner delete popup delete button xpath}
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${community banner delete popup cancel button xpath}

KW: Click the delete button from the popup.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element       ${community banner delete popup delete button xpath}

KW: Reupload valid community banner again.
    Wait Until Keyword Succeeds         10sec       1sec        Upload File     ${add banner button xpath}     ${branding_folder_path}community_banner2.png       anchor=Community Banners

KW: Upload valid community banner to show the cropping popup appears or not.
    Wait Until Keyword Succeeds         30sec       10sec        Upload File     ${add banner button xpath}     ${branding_folder_path}login_BANNER.png       anchor=Community Banners

KW: Verify the uploaded community banner image on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
    Wait Until Keyword Succeeds         30sec       10sec        Verify Icon         ${branding_uploaded_folder_path}uploaded_community_banner.png      #template_res_w=643     browser_res_w=1680         #1680 #3360
    Set Config    Retina Display       False

KW: Wait for the community login banner crop popup.
    Wait Until Keyword Succeeds         30sec       10sec        Verify Element      ${community login banner cropping popup xpath}

KW: Sroll the page to the event landing page toggle button.
    Wait Until Keyword Succeeds         10sec       1sec        Scroll Text     Community Banners       anchor=Maximum 30 allowed. Know more in Event Branding
...
KW: Verify the uploaded event logo image on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
...
KW: Upload invalid image for the community login banner.
    Wait Until Keyword Succeeds         10sec       1sec        Upload File     ${community login banner button xpath}     ${maroon branding color}       anchor=Event Logo

KW: Verify the invaid image upload community login banner alert.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element Text       ${branding saving green success alert xpath}         Error
...
KW: Upload valid image for the community login banner 1.
    Wait Until Keyword Succeeds         30sec       10sec        Upload File     ${community login banner button xpath}     ${branding_folder_path}login_BANNER.png       anchor=Login Banners

KW: Upload valid image for the community login banner 2.
    Wait Until Keyword Succeeds         30sec       10sec        Upload File     ${community login banner button xpath}     ${branding_folder_path}community_login_banner2.png       anchor=Login Banners

KW: Sroll the page to the community login banner text area.
    Wait Until Keyword Succeeds         30sec       10sec        Scroll Text     Login Banners       anchor=1280x1080px | 5MB (Maximum)

KW: Verify the icon uploaded_community_login_banner1 on the dashboard.
    Wait Until Keyword Succeeds         20sec       5sec        Verify Icon         ${branding_uploaded_folder_path}uploaded_community_login_banner1.png      #template_res_w=630     browser_res_w=1680         #1680 #3360

KW: Verify the icon uploaded_community_login_banner2 on the dashboard.
    Wait Until Keyword Succeeds         20sec       5sec        Verify Icon         ${branding_uploaded_folder_path}uploaded_community_login_banner2.png      #template_res_w=643     browser_res_w=1680         #1680 #3360

KW: Verify the uploaded 2 community login banner image on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
    # ${Check community login banner 1 on the dashboard}        Is Icon     ${branding_uploaded_folder_path}uploaded_community_login_banner1.png      #template_res_w=630     browser_res_w=1680         #1680 #3360
    # ${Check community login banner 2 on the dashboard}        Is Icon     ${branding_uploaded_folder_path}uploaded_community_login_banner2.png      #template_res_w=643     browser_res_w=1680         #1680 #3360
    # Run Keyword If      '${Check community login banner 1 on the dashboard}'=='True'       Run Keyword         KW: Verify the icon uploaded_community_login_banner1 on the dashboard.
    # Run Keyword If      '${Check community login banner 2 on the dashboard}'=='True'       Run Keyword         KW: Verify the icon uploaded_community_login_banner2 on the dashboard.
    KW: Verify the icon uploaded_community_login_banner1 on the dashboard.
    KW: Verify the icon uploaded_community_login_banner2 on the dashboard.
    Set Config    Retina Display       False
    # Run Keyword If      '${Check community login banner 1 on the dashboard}'=='False'       Run Keyword         Fail
    # Run Keyword If      '${Check community login banner 2 on the dashboard}'=='False'       Run Keyword         Fail
...
KW: Type video link on the video link field.
    ${palipoint youtube link}=     Convert To String       https://www.youtube.com/watch?v=bvLxuw7_4QQ
    Set Global Variable     ${palipoint youtube link}
    Wait Until Keyword Succeeds         10sec       1sec        Type Text       ${video link field xpath}       ${palipoint youtube link}         anchor=Video Link
...
KW: Verify the title, description, url is displaying.
    ...
    Wait Until Keyword Succeeds         10sec       1sec        Verify Text     ${palipoint youtube link}      anchor=Description:

KW: Verify the uploaded youtube video image on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
...
KW: Click image upon the uploaded youtube play to watch the video.
    ...
    # Set Config    Retina Display       False
    # QWeb.Click Element      ${dashboard welcome video youtube added play button}     js=true
    # Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${dashboard welcome video youtube added play button}     js=true
    # KW: Hover upon the uploaded youtube video thumbnail.
    # Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      Play        tag=button      index=1      js=true        timeout=10s
    KW: Check wethere the youtube play icon is present.
...
KW: Verify the uploaded Cover Images for Attendees on the dashboard.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
...
KW: Verify the delete option is present in the welcome video from dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${dashboard welcome video youtube added delete button}      js=true

KW: Delete welcome video from dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${dashboard welcome video youtube added delete button}     js=true
...
KW: Verify the welcome video delete popup iframe appears.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${dashboard welcome video youtube delete popup iframe xpath}        js=true
...
KW: Verify the welcome video delete popup iframe Cancel button appearence.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${dashboard welcome video youtube delete popup iframe cancel button xpath}      js=true

KW: Verify the welcome video delete popup iframe Delete button appearence.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${dashboard welcome video youtube delete popup iframe delete button xpath}      js=true

KW: Click on the welcome video delete popup iframe Delete button appearence.
    # Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${dashboard welcome video youtube delete popup iframe delete button xpath}     js=true
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Text     Delete      anchor=CANCEL    

KW: Verify the welcome video youtube video frame is deleted from the dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        Verify No Element       ${video youtube tumbnail xpath}         timeout=5s

KW: Click on the welcome video youtube video frmae on the dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element       ${video youtube tumbnail xpath}         timeout=5s

KW: Scroll to Community Banners section.
    Wait Until Keyword Succeeds         10sec       1sec        Scroll Text     Community Banners       anchor=Maximum 50 allowed

KW: Scroll to Community Event Logo section.
    Wait Until Keyword Succeeds         10sec       1sec        Scroll Text     Event Logo       anchor=Width or Height has to be at least

KW: Hover upon the uploaded Community Event Logo image.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${dashboard event logo uploaded image xpath}        index=1

KW: Hover upon the delete option, which is a added community Event Logo image once hovered.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${dashboard event logo uploaded image delete button xpath}      index=1
...
KW: Click the delete icon over the community Event Logo image.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
    # KW: check wethere the delete icon is present.
...
KW: Verify the Event Logo image frame is deleted from the dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        Verify No Element       ${dashboard event logo uploaded image xpath}        timeout=5s

KW: Hover upon the uploaded Community favicon Logo image.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${favicon after uploading element xpath}

KW: Click upon the uploaded Community favicon Logo image.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element       ${favicon after uploading element xpath}       js=true

KW: Click on the Delete option of favicon log image from dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${uploaded community event favicon logo image and the delete option xpath}     js=true
    # Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      Delete        tag=button        js=true

KW: Verify the favicon log image is deleted from the dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        Verify No Element       ${favicon after uploading element xpath}

KW: Hover upon the uploaded Community uploaded login banner image.
    Wait Until Keyword Succeeds         10sec       1sec        Hover Element       ${uploaded community login banner image element xpath}      timeout=10s

KW: Click on the Delete option of Community uploaded login banner image from dashboard.
    KW: Hover upon the uploaded Community uploaded login banner image.
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${uploaded community event favicon logo image and the delete option xpath}     js=true
...
KW: Click the delete button on the last community login banner on the dashboard.
    KW: Hover upon the uploaded Community uploaded login banner image.
    # Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      Delete        tag=button        index=0      js=true
    Wait Until Keyword Succeeds         10sec       1sec        QWeb.Click Element      ${last community login banner image on the dashboard xpath}      js=true

KW: Verify the last community login banner is not present after deleting from the dashboard.
    Wait Until Keyword Succeeds         10sec       1sec        Verify No Element       ${uploaded community login banner image element xpath}
