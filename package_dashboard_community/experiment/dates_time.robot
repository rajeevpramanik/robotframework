...
KW: Manipulate current time
    ...
    ${newdatetime_for_4_days} =  Add Time To Date  ${CurrentDate}  4 days
    # Log  ${newdatetime_for_7_days}
    Set Global Variable     ${newdatetime_for_4_days}
    ...
    ${updated_4_days}=      Convert Date    ${newdatetime_for_4_days}       datetime
    ...
    ${future_updated_4_days}=   Set Variable        ${updated_4_days.day}
    Set Global Variable     ${future_updated_4_days}
...
*** Test Cases ***
TC: Manipulate current time
    KW: Manipulate current time

TC: Manipulate current time with extended dates and time
    KW: Manipulate current time with extended dates and time

TC: Manipulate current time with modifications.
    KW: Manipulate current time with modifications.

# TC: Generating yopmail email.
#     KW: Manipulate current time
