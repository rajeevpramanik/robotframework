*** Settings ***
Documentation    POM or Variables and Keywords for Updating Booking.
...
KW: PUT Body with JSON Keys & Value.
...
KW: Response of the PUT Request.
    [Documentation]
