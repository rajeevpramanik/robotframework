...
KW: Manipulate current time
    ...
    ${next_day_after_4th_day} =     Add Time To Date  ${CurrentDate}  2 days
    Set Global Variable     ${next_day_after_4th_day}
    ...
    ${updated_next4th_days}=    Convert Date    ${next_day_after_4th_day}   datetime
    ...
    ${future_4th_day_is}=       Set Variable        ${updated_next4th_days.day}
    Set Global Variable     ${future_4th_day_is}
