...
# ${v2qat super admin cms url}      https://admin.v2qat.demopalipoint.com
# ${v2qat admin cms url}            https://newcms.v2qat.demopalipoint.com

# ${v2rel super admin cms url}      https://admin.v2release.demopalipoint.com
# ${v2rel admin cms url}            https://newcms.v2release.demopalipoint.com

# ${v2swat super admin cms url}     https://admin.v2swat.demopalipoint.com
# ${v2swat admin cms url}           https://newcms.v2swat.demopalipoint.com
