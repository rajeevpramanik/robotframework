...
robot -d    html_reports    --skip visual --skip negative  --variable admincmsurl:https://newcms.v2qat.demopalipoint.com  --suite pom_tc_suites.03_tc_login       --suite pom_tc_suites.14_tc_integration_salesforce        pom_tc_suites