...
class Predefined_User_Agent():
    ...
    def GET_UserAgent(self):
        ...
        self.randomUserAgent = random.choice(self.user_agents)
        print("The Random User Agent is: ", self.randomUserAgent)


Object_Predefined_User_Agent = Predefined_User_Agent()
Object_Predefined_User_Agent.GET_UserAgent()