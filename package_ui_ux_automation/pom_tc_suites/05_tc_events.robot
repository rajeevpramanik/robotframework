...
#    Fail                Failing the text case   Deprecated  Smoke Test
    ...
    run keyword and continue on Failure             KW: Expect texts on the events page.

TC2: [POSITIVE] [Events page]- Interaction with creating event side panel.
    [Documentation]     This tc's is going perform Login page "CREATE AN ACCOUNT" verification and validation with redirecting.
    [Tags]              positive
#    Skip     Skipping the test case
#    Pass Execution      Passing the test case   deprecated	-regression
...
TC3: [POSITIVE] [Events page]- Interaction with Language Settings event side panel and creating the event.
    [Documentation]     This tc's is going perform Login page "CREATE AN ACCOUNT" verification and validation with redirecting.
    [Tags]              positive
#    Skip     Skipping the test case
#    Pass Execution      Passing the test case   deprecated	-regression
