...
#    Fail                Failing the text case   Deprecated  Smoke Test
    ...
    run keyword and continue on Failure         KW: Click on the How many events do you host in a year? *
    run keyword and continue on Failure         KW: Select value from the How many events do you host in a year? * drop down.

    run keyword and continue on Failure         KW: Click on the How many attendees visit your events? *
    run keyword and continue on Failure         KW: Select value from the How many attendees visit your events? * drop down.
