...
***Variables***
${three dots for delete events image}=              ${events_three_dots_image}delete_events_option.png
...
KW: Delete all events.
    # KW: Click on the UPCOMING VIEW ALL element.
    ${find the 3 dots image}=       Is Icon     ${three dots for delete events image}
