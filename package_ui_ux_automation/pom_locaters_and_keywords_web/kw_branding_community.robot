...
KW: Scroll to the video frame description area on the reception page.
    Wait Until Keyword Succeeds         10sec       1sec        Scroll Text      We help event organizers save their time, effort, and resources by enabling them to host global events virtually.      anchor=gurupoint Virtual Event Platform

KW: Scroll to the video frame title area on the reception page.
    Wait Until Keyword Succeeds         10sec       1sec        Scroll Text     gurupoint Virtual Event Platform       anchor=We help event organizers save their time, effort, and resources by enabling them to host global events virtually.
