...
${webcommunity login page powered palipoint logo element xpath}           xpath\=//div[@class\='poweredBlock']

***Keywords***
KW: Wait and verify the powered palipoint logo element is present.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element      ${webcommunity login page powered palipoint logo element xpath}
...
KW: Verify and compare the default event webcommunity login banner palipoint has on the webcommunity login page.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
    # ${Check the default webcommunity login banner on the webcommunity}        Is Icon     ${branding_folder_path}default_login_banner.png      #template_res_w=244     browser_res_w=1680         #1680 #3360
    # KW: Check the boolean value for default webcommunity login banner.
...
KW: Verify the title, description, url is displaying on the webcommunity youtube reception bottom page.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element Text     ${event video title reception webcommunity xpath}      ${video title is}       anchor=We help event organizers save their time, effort, and resources by enabling them to host global events virtually.
    Wait Until Keyword Succeeds         10sec       1sec        Verify Element Text     ${event video description reception webcommunity xpath}     ${video description is}     anchor=palipoint Virtual Event Platform
