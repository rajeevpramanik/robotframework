...
${salesforce info}                                  Connect Salesforce to export the registration data seamlessly from palipoint to Salesforce
${Integrate with Salesforce text}                   Integrate with Salesforce
${salesforce note text}                             Note, The registration data is synced at an interval of 5 minutes from palipoint to Salesforce, Changes will be reflected on your Salesforce after that
${salesforce note2 text}                            palipoint's Salesforce integration will enable you to manage your event leads and customer relationship data using robust functionality of Salesforce
${salesforce INTEGRATIONS : text}                   INTEGRATIONS :
${salesforce INTEGRATIONS info}                     Export your registration(attendee) data to Salesforce objects, Export the profile fields of your choice to the Salesforce object of your choice like leads, contacts or any other custom Salesforce object, Import registration data from your Salesforce object to palipoint events
${Connect with Salesforce text}                     Connect with Salesforce
${Connect with Salesforce info}                     Connect your Salesforce account to authenticate palipoint to access your organisation's account
...
KW: Varify the palipoint+salesforce icon/logo on the salesforce sidepanel frame is present.
    # Set Config    Retina Display       True
    # Set Config    Log Matched Icons       True
    ${palipoint+salesforce is icon true or false}             Is Icon         ${integration_salesforce_image}palipoint_plus_salesforce.png
    Set Global Variable     ${palipoint+salesforce is icon true or false}
    # Set Config    Retina Display       False    

KW: Second verification on the palipoint+salesforce icon/logo on the salesforce sidepanel frame is present.
    # Set Config    Retina Display       True
    # Set Config    Log Matched Icons       True
    Wait Until Keyword Succeeds         30sec       10sec        Verify Icon         ${integration_salesforce_image}palipoint_plus_salesforce.png
    # Set Config    Retina Display       False

KW: Condition to check the palipoint+salesforce icon/logo and validate the icon/logo.
    Set Config    Retina Display       True
    Set Config    Log Matched Icons       True
    KW: Varify the palipoint+salesforce icon/logo on the salesforce sidepanel frame is present.
    Run Keyword If      '${palipoint+salesforce is icon true or false}'=='True'       Run Keyword         KW: Second verification on the palipoint+salesforce icon/logo on the salesforce sidepanel frame is present.
    Run Keyword If      '${palipoint+salesforce is icon true or false}'=='False'       Run Keyword         Fail
    Set Config    Retina Display       False
