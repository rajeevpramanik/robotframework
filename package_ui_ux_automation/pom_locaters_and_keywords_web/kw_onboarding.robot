...
${Tell_us_about_the_place_you_host}                xpath\=//span[contains(text(),'Tell us about the place you host')]
...
${Pick the host country of your place xpath}             xpath\=//body/main[@id\='root']/div[2]/section[1]/section[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[6]/div[1]/div[1]/div[1]/div[1]
...
@{Pick the host country of your place value}=          United States       Australia       Brazil      Greece      Ukraine     Zimbabwe

***Keywords***
KW: Click on the How many place do you host in a year? *
    QWeb.Click Element       ${select the number closest to your choice xpath}

KW: Select value from the How many place do you host in a year? * drop down.
...
KW: Click on the How many attendees visit your place? *
    QWeb.Click Element       ${Select the average number of attendees xpath}

KW: Select value from the How many attendees visit your place? * drop down.
...
KW: Click on the Select the Country *
    QWeb.Click Element       ${Pick the host country of your place xpath}

KW: Select value from the Select the Country * drop down.
    ${length of Pick the host country of your place value}=    get length  ${Pick the host country of your place value}
    ${random_NUMBER}=   evaluate    random.randint(0,${length of Pick the host country of your place value}-1)
    ${The final value from the list is}=    Get From List       ${Pick the host country of your place value}       ${random_NUMBER}
    QWeb.Click Text      ${The final value from the list is}
