...
robot -d    html_reports    --skip visual --skip negative  --variable environment:v2swat    --suite pom_tc_suites.03_tc_login       --suite pom_tc_suites.05_tc_place        pom_tc_suites