@REM # cd
@REM # cd /Users/rajeev/Documents/palipoint_projects/palipoint_automation/package_cms_webcommunity
...
robot -d    html_reports    --skip visual --skip negative  --variable admincmsurl:https://newcms.v2swat.demopalipoint.com  --suite pom_tc_suites.03_tc_login       --suite pom_tc_suites.14_tc_integration_salesforce        pom_tc_suites