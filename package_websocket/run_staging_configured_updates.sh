...
robot -d    html_reports        --skip negative  --variable environment:staging    --suite test_suite.test1_echo_raw      test_suite       #--suite test_suite.test2_echo_raw_queryparams        test_suite