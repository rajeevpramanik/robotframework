...
@REM --suite test_suite.test1_echo_raw ^
@REM --suite test_suite.test2_echo_raw_queryparams ^
@REM --suite test_suite.test3_echo_header ^
@REM --suite test_suite.test4_echo_json ^
C:
